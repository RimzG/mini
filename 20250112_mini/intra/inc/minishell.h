...
int				execute_pipeline(char **args, t_shell *shell,
...
void			handle_child(char **args, t_shell *shell,
					int next_pipe, int *pipefd);
void			handle_parent_pipes(int *prev_pipe, int *pipefd);
void			handle_child_process(char **args, t_shell *shell,
					int *pipefd, t_pipe_data data);
